...
(function () {
  console.log("🔵 Liora Dashboard PREMIUM v7.1 carregado");
  ...
  document.addEventListener("DOMContentLoaded", () => {
    ...
    if (
      ...
      console.warn("⚠️ Dashboard: elementos não encontrados.");
      return;
    }
    ...
    function renderDashboard() {
      ...
      if (!temSimulados && !temEstudos) {
        ...
        els.dashEmpty.innerHTML = `
          <div class="text-center opacity-80">
            <p class="text-sm">Você ainda não fez simulados nem criou planos de estudo.</p>
      ...
      if (temSimulados) {
        mediaPerc =
          Math.round(
            (hist.reduce((a, h) => a + Number(h.perc || 0), 0) / hist.length) * 10
          ) / 10;
    ...
    console.log("🟢 Dashboard PREMIUM v7.1 pronto");
  });
})();
